<div class="container-fluid">
    ...
    <h4 class="h5 align-middle m-0 font-weight-bold text-primary"></h4>
        ...
        <?php foreach ($ujian as $u) { ?>
            ...
            <form action="<?php echo base_url('soal_evaluasi_ujian/update_aksi') ?>" method="post">
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label"> Mata Kuliah<i style="color:red">*</i></label>
                    <div class="col-sm-10">
                        <select class="form-control" name='id_mata_kuliah' id='id_mata_kuliah' value="<?php echo $jr->id_mata_kuliah; ?>">
                            <option value='0' selected  disabled>--- Pilih Jenis Ruangan ---</option>
                            <?php foreach ($matakuliah as $mk) { ?>
                                <option value="<?php echo $mk->id_mata_kuliah; ?>" <?php if ($mk->id_mata_kuliah == $u->id_mata_kuliah) {
                                                                                        echo "selected";
                ...
                <input type="hidden" name="id_soal_evaluasi" value="<?php echo $u->id_soal_evaluasi ?>">
                <div class="form-group row">
