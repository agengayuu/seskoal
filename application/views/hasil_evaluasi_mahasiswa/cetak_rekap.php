	...
	<div class="container">
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<h5 align="left">Nama   : <?php echo $m->nama; ?> </h5>
				<h5 align="left">NIM    : <?php echo $m->nim; ?> </h5>
				<h5 align="left">Diklat : <?php echo $m->nama_diklat; ?> </h5>
				<h5 align="left">Tahun akademik : <?php echo $m->tahun_akademik; ?> </h5>
			</section>
            <?php }	?>
