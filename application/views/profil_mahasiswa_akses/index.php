            ...
            <div class="row">
                ...
                <!-- <form action="<?php echo base_url('profil_mahasiswa_akses/detail') ?>"> -->
                    ...
                    <div class="mb-4 ml-4 mr-4" >
                        <div class="mb-3">
                            <div>
                            <?php echo anchor('profil_mahasiswa_akses/edit/', '<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Edit</div>' ) ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control" placeholder="Masukkan Tempat Lahir" id="tempat_lahir" value="<?php echo ($datadiri->tempat_lahir) ? $datadiri->tempat_lahir : '' ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="">Tanggal Lahir</label>
                            <input type="date" name="tgl_lahir" class="form-control" placeholder="Masukkan Tanggal Lahir" id="tgl_lahir" value="<?php echo ($datadiri->tgl_lahir) ? $datadiri->tgl_lahir : '' ?>" readonly>
                        </div>
                        <div class="radio-group">
                            <label for="">Jenis Kelamin</label>
                        </div>
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki" value="Laki-Laki" <?php echo ($datadiri->jenis_kelamin == 'Laki-Laki') ? 'checked' : '' ?> readonly>
                            <label class="form-check-label">Laki Laki</label>
                        </div>
                        <div class="form-check form-check-inline mb-2">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="perempuan" value="Perempuan" <?php echo ($datadiri->jenis_kelamin == 'Perempuan') ? 'checked' : '' ?> readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="angkatan" class="form-control" placeholder="Masukkan Angkatan" id="angkatan" value="<?php echo ($datadiri->angkatan) ? $datadiri->angkatan : '' ?>" readonly>
                        </div>
                        <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <form action="">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="kewarganegaraan" class="form-control" placeholder="Masukkan Kewarganegaraan" id="kewarganegaraan" value="<?php echo ($datadiri->kewarganegaraan) ? $datadiri->kewarganegaraan : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">NIK</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="nik" class="form-control" placeholder="Masukkan NIK" id="nik" value="<?php echo ($datadiri->nik) ? $datadiri->nik : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">NPWP</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="npwp" class="form-control" placeholder="Masukkan NPWP" id="npwp" value="<?php echo ($datadiri->npwp) ? $datadiri->npwp : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Jalan</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="jalan" class="form-control" placeholder="Masukkan Jalan" id="jalan" value="<?php echo ($datadiri->jalan) ? $datadiri->jalan : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Dusun</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="dusun" class="form-control" placeholder="Masukkan Dusun" id="dusun"value="<?php echo ($datadiri->dusun) ? $datadiri->dusun : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">RT</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="rt" class="form-control" placeholder="Masukkan RT" id="rt" value="<?php echo ($datadiri->rt) ? $datadiri->rt : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">RW</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="rw" class="form-control" placeholder="Masukkan RW" id="rw" value="<?php echo ($datadiri->rw) ? $datadiri->rw : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Kelurahan</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="kelurahan" class="form-control" placeholder="Masukkan Kelurahan" id="kelurahan" value="<?php echo ($datadiri->kelurahan) ? $datadiri->kelurahan : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Kecamatan</i></label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="kecamatan" class="form-control" placeholder="Masukkan Kecamatan" id="kecamatan" value="<?php echo ($datadiri->kecamatan) ? $datadiri->kecamatan : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Kode Pos</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="kode_pos" class="form-control" placeholder="Masukkan Kode Pos" id="kode_pos" value="<?php echo ($datadiri->kode_pos) ? $datadiri->kode_pos : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Telepon</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="text" name="no_tlp" class="form-control" placeholder="Masukkan Telepon" id="no_tlp" value="<?php echo ($datadiri->no_tlp) ? $datadiri->no_tlp : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label for="" class="col-sm-3 col-form-label">Email</label>
                                                                                    <div class="col-sm-6">
                                                                                        <input type="email" name="email" class="form-control" placeholder="Masukkan Email" id="email" value="<?php echo ($datadiri->email) ? $datadiri->email : '' ?>" readonly>
                                                                                    </div>
                                                                                </div>
                                                                            </form>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">NIK </label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="nik_ortu[]" class="form-control" placeholder="Masukkan NIK" id="nik"  value="<?php echo ($ayah != '') ? $ayah->nik_ortu :''?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Nama</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="nama_ortu[]" class="form-control" placeholder="Masukkan Nama" id="nama"  value="<?php echo ($ayah != '') ? $ayah->nama_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Tempat Lahir</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="tempat_lahir_ortu[]" class="form-control" placeholder="Masukkan Tempat Lahir" id="tempat_lahir"  value="<?php echo ($ayah != '') ? $ayah->tempat_lahir_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Tanggal Lahir</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="date" name="tgl_lahir_ortu[]" class="form-control" placeholder="Masukkan Tanggal Lahir" id="tgl_lahir"  value="<?php echo ($ayah != '') ? $ayah->tgl_lahir_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Pekerjaan</label>
                                                                                <div class="col-sm-6">
                                                                                    <select class="form-control" name="pekerjaan_ortu[]" id="pekerjaan" readonly>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <select class="form-control" name="pendidikan_ortu[]" id="pekerjaan" readonly>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <select class="form-control" name="penghasilan_ortu[]" id="penghasilan"readonly>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">NIK</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="nik_ortu[]" class="form-control" placeholder="Masukkan NIK" id="nik" value="<?php echo ($ibu != '') ? $ibu->nik_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Nama</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="nama_ortu[]" class="form-control" placeholder="Masukkan Nama" id="nama" value="<?php echo ($ibu != '') ? $ibu->nama_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Tempat Lahir</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="text" name="tempat_lahir_ortu[]" class="form-control" placeholder="Masukkan Tempat Lahir" id="tempat_lahir" value="<?php echo ($ibu != '') ? $ibu->tempat_lahir_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Tanggal Lahir</label>
                                                                                <div class="col-sm-6">
                                                                                    <input type="date" name="tgl_lahir_ortu[]" class="form-control" placeholder="Masukkan Tanggal Lahir" id="tgl_lahir" value="<?php echo ($ibu != '') ? $ibu->tgl_lahir_ortu : '' ?>" readonly>
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label for="" class="col-sm-3 col-form-label">Pendidikan</label>
                                                                                <div class="col-sm-6">
                                                                                    <select class="form-control" name="pendidikan_ortu[]" id="pendidikan" readonly>
                                                                                        <option value="" style="display:none;">--- Pilih Pendidikan ---</option>
