<div class="container-fluid">
    ...
    <form method="post" action="<?php echo base_url('menu/simpansub') ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" placeholder="Masukkan Nama Sub Menu" class="form-control" required>
            ...
            <input type="text" name="url" placeholder="Masukkan Nama Sub Menu" class="form-control" required>
